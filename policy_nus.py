...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='mirFlickr', help='the name of dataset')
    ...
    # pth_file = os.path.join(opt.ckpt_dir, f't_policy_{opt.binary_bits}' f'bits_m{opt.margin}r2p4.pth')
