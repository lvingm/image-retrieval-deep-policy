...
def compute_AP(trn_binary, tst_binary, trn_label, tst_label):
    """
    ...
    for i in range(tst_binary.size(0)):
        ...
        correct = (query_label == trn_label[query_result]).type(torch.FloatTensor)
...
class MyDataset(torchdata.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # img = self.loader('/home/disk2/yangyifan/cifar10/'+words[0])  # 2
        # img = self.loader('/home/disk2/yangyifan/data/cifar10'+words[0]) # 3
        img = self.loader('/home/disk2/yangyifan/data/cifar10/' + words[0])  # 1
        # img = self.loader('/home/disk1/yangyifan/data/cifar10/' + words[0])  # 4
...
def init_cifar_dataloader(batchSize):
    root_dir = os.getcwd() + '/cifar10_txt/'
    ...
    train_dir = root_dir+'train_500_per_cls.txt'
