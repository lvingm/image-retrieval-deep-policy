...
def compute_topK_precision(db_binary, db_labels, tst_binary, tst_labels):
    ...
    for i in range(10):
        ...
        for i in range(tst_binary.size(0)):
            ...
            correct = (query_label == db_labels[idx]).type(torch.FloatTensor)
...
def hamming_precision(db_binary, db_labels, tst_binary, tst_labels, radius):
    ...
    for i in range(tst_binary.size(0)):
        ...
        similarity = (query_label == db_labels).type(torch.FloatTensor)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_dir', type=str, default=current_dir + '/result_cifar10/',
    ...
    # print('start to calculate precision within hamming radius 2 and top k precision...')
    # # calculate precision within hamming radius 2
    # ham2_precision = hamming_precision(db_binary, db_label, tst_binary, tst_label, 2)
    # print(f'precision within hamming radius 2 is: {ham2_precision:.4f}')
    #
